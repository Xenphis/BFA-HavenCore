...
// OpenSSL 3.x removed OPENSSL_VERSION constant; use OPENSSL_VERSION_STRING instead
#if OPENSSL_VERSION_NUMBER >= 0x30000000L
#  define TC_OPENSSL_VERSION_ARG OPENSSL_VERSION_STRING
#else
#  define TC_OPENSSL_VERSION_ARG OPENSSL_VERSION
#endif
...
extern int main(int argc, char** argv)
{
    ...
    Trinity::Banner::Show("worldserver-daemon",
        ...
        []()
        {
            ...
            TC_LOG_INFO("server.worldserver", "Using SSL version: %s (library: %s)", OPENSSL_VERSION_TEXT, OpenSSL_version(TC_OPENSSL_VERSION_ARG));
